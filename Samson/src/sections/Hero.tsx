          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <Reveal delayMs={280}>
              <div className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-4">
                <a href="/CV%20Samson.pdf" download="CV-Samson-Chifamba.pdf" className="rounded-full bg-primary px-8 py-4 text-primary-foreground font-semibold shadow-lg transition-all hover:bg-primary/90 hover:shadow-xl hover:-translate-y-px active:translate-y-px">
                  {t('hero.downloadCV')}
                </a>
